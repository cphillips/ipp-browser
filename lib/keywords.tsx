...
let Job_Template_attribute_names = Object.keys(attributes["Job Template"]);
let Job_Template_and_Operation_attribute_names = Job_Template_attribute_names.concat(Object.keys(attributes["Operation"]))
let Printer_attribute_names = Object.keys(attributes["Job Template"]).concat(["none"]);
let media_name_or_size = media["media name"].concat(media["size name"]);
...
keywords["document-format-letying-attributes"] = setof_keyword(
